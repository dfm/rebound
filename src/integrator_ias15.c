...
void predict_next_step(double ratio, int N3, double* _e[8], double* _b[8]){
	...
	for(int k=0;k<N3;++k) {
		...
		e[2][k] = 0;//q3*(_b[7][k]*  .0 + _b[6][k]*35.0 + _b[5][k]*20.0 + _b[4][k]*10.0 + _b[3][k]* 4.0 + _b[2][k]);
		e[3][k] = 0;//q4*(_b[7][k]*  .0 + _b[6][k]*35.0 + _b[5][k]*15.0 + _b[4][k]* 5.0 + _b[3][k]);
		e[4][k] = 0;//q5*(_b[7][k]*  .0 + _b[6][k]*21.0 + _b[5][k]* 6.0 + _b[4][k]);
