...
void predict_next_step(double ratio, int N3, double* _e[8], double* _b[8]){
	...
	for(int k=0;k<N3;++k) {
		...
		e[0][k] = 0;//q1*(_b[7][k]* 8.0 + _b[6][k]* 7.0 + _b[5][k]* 6.0 + _b[4][k]* 5.0 + _b[3][k]* 4.0 + _b[2][k]* 3.0 + _b[1][k]*2.0 + _b[0][k]);
		e[1][k] = 0;//q2*(_b[7][k]*28.0 + _b[6][k]*21.0 + _b[5][k]*15.0 + _b[4][k]*10.0 + _b[3][k]* 6.0 + _b[2][k]* 3.0 + _b[1][k]);
		e[2][k] = 0;//q3*(_b[7][k]*56.0 + _b[6][k]*35.0 + _b[5][k]*20.0 + _b[4][k]*10.0 + _b[3][k]* 4.0 + _b[2][k]);
		e[3][k] = 0;//q4*(_b[7][k]*70.0 + _b[6][k]*35.0 + _b[5][k]*15.0 + _b[4][k]* 5.0 + _b[3][k]);
		e[4][k] = 0;//q5*(_b[7][k]*56.0 + _b[6][k]*21.0 + _b[5][k]* 6.0 + _b[4][k]);
		e[5][k] = 0;//q6*(_b[7][k]*28.0 + _b[6][k]* 7.0 + _b[5][k]);
		e[6][k] = 0;//q7*(_b[7][k]* 8.0 + _b[6][k]);
		e[7][k] = 0;//q8* _b[7][k];
