...
"<cat ias15_cs_rms/energy_orbits_1.000e+10__run_*" w d lt 1 ps 1  notit, \
3e-16*sqrt(x) ls 3 lw 3 t "t^{0.5}", \
4e-19*x ls 4 lw 3 t "t^{1}", \


#"<sort -g -k 1 ias15_cs_rms/energy_orbits_1.000e+10__run_* | awk -f rms.awk" w p lt 1 pt 7 notit , 1/0 w p t "IAS15 cs RMS" lt 3 pt 7 ps 1.5, \
